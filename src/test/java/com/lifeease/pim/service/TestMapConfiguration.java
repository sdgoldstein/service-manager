...
public class TestMapConfiguration
{
    ...
    public void testGetPutContainsProperty()
    {
        ...
        assertEquals("testGetPutContainsProperty - Ensure property can be retrieved as expected",
                     propertyValue,
                     retrievedValue);
        ...
        try
        {
            ...
            fail("testGetPutContainsProperty - Should thrown IllegalArgumentException for null argument to getProperty");
        }
        catch (IllegalArgumentException exception)
        {
        }
        ...
        try
        {
            ...
            fail("testGetPutContainsProperty - Should thrown IllegalArgumentException for null name argument to putProperty");
        }
        catch (IllegalArgumentException exception)
        {
        }
        ...
        try
        {
            ...
            fail("testGetPutContainsProperty - Should thrown IllegalArgumentException for null name value to putProperty");
        }
        catch (IllegalArgumentException exception)
        {
        }
        ...
        try
        {
            ...
            fail("testGetPutContainsProperty - Should thrown IllegalArgumentException for null argument to containsProperty");
        }
        catch (IllegalArgumentException exception)
        {
        }
